...
public class GourmetCoffee {
	...
	/**
	 * Constructs a <code>GourmetCoffee</code> object. Initializes the catalog data
	...
	/**
	 * Creates a new file (which has the specified name) and writes the specified
	 * string to the new file.
	 *
